...
# Form implementation generated from reading ui file '180d.ui'
#
...
class Ui_MainWindowOd(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("../../Downloads/180d sub.jpg"))
...
"border-radius: 20px;")
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(1000, 450, 301, 71))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(21)
        font.setBold(True)
...
"border-radius: 20px;")
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(1000, 600, 721, 71))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(21)
        font.setBold(True)
...
"border-radius: 20px;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(730, 760, 341, 81))
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
    ...
    def subscribe(self):
        ...
        expiry_date= self.lineEdit_4.text()
